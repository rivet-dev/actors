...
| `RIVET_RUN_SERVICES` | Set to `1` to run managed services with a local engine, or `0` to disable it. By default, managed services follows RivetKit's local-engine decision. |
