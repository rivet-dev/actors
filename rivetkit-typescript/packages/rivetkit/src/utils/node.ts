...
export function loadNodeBuiltin<T>(id: NodeBuiltin): T {
	...
	// tsup preserves it in CommonJS output, which makes the require entrypoint
	// invalid. This loader only resolves built-ins, so the fallback base does not
	// affect package resolution.
