...
const MIGRATION_V2: &[&str] = &[
	"ALTER TABLE _rivet_schedule_events ADD COLUMN origin_ray_id TEXT",
	"ALTER TABLE _rivet_schedule_events ADD COLUMN origin_traceparent TEXT",
	"ALTER TABLE _rivet_schedule_events ADD COLUMN origin_tracestate TEXT",
	"ALTER TABLE _rivet_queue ADD COLUMN origin_ray_id TEXT",
	"ALTER TABLE _rivet_queue ADD COLUMN origin_traceparent TEXT",
	"ALTER TABLE _rivet_queue ADD COLUMN origin_tracestate TEXT",
];
